...
import Infra from "./contracts/Infra.sol/Infra.json";
import Web3 from 'web3';
const InfraAddress='0xa6251f4a88205985B632E9694134FbDA09AE9091'
...
class App extends Component {
    ...
    async loadBlockChain() {
        ...
        const networkData = InfraAddress
        console.log(networkId);
        if (networkData) {
            const rideManager = new web3.eth.Contract(Infra.abi, InfraAddress);
